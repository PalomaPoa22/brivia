...
export default function Header() {
  return (
    ...
    <Link to='/lista'className="lk-acesse"><img src={botao} alt="link de acesso" /></Link>
    <Link to='/lista'className="lk-acesse-mobile"><img src={botao1} alt="link de acesso" /></Link>
</div>
